...
<h1>Adicionar novos livros</h1>
    ...
    <footer>
        <table class="table">
            ...
            <tbody>
            <tr>
                    <td><a href="./add_livro.php">Livro</a></td>
                    <td><a href="./add_autor.php">Autor</a></td>
                    <td><a href="./add_avaliacao.php">Avaliação</a></td>
                </tr>
                <tr>
                    <td><a href="./add_editora.php">Editoras</a></td>
                    <td><a href="./add_leitor.php">Leitor</a></td>
                    <td><a href="./add_emprestimo.php">Emprestimos</a></td>
                </tr>
            </tbody>
        </table>
